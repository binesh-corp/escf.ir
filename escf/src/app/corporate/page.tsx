...
export default function Page() {
    return (
        <div>
            <main  className="mt-100 mb-100 default-transition" style={{backgroundImage:"url(/images/Corporate.jpg)",backgroundSize:"cover",opacity: 1}}>
                            ...
                            <form className="mt-100 mb-100">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <h2>ورود به حساب کابری متقاضی</h2>
