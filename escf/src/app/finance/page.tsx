...
export default function Page() {
    return (
        <div>
            <main  className="mt-100 mb-100 default-transition" style={{backgroundImage:"url(/images/Finance-Predictions.jpg)",backgroundSize:"cover",opacity: 1}}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="mb-3 field-losloginform-mobile required">
                                            ...
                                            <input type="text" id="losloginform-mobile" className="form-control"
                                                   />
                                            <div className="form-text text-muted">شماره موبایل</div>
                                            <div className="invalid-feedback"></div>
                                        </div>
